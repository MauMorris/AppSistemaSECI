...
*/
        ...
        private void AudioBeamChanged()
        {
            ...
            beamAngleText.Text = string.Format(CultureInfo.CurrentCulture,
                                                    Properties.Resources.BeamAngle,
                                                        beamAngleInDeg.ToString("0", CultureInfo.CurrentCulture));
            beamConfidenceText.Text = string.Format(CultureInfo.CurrentCulture,
